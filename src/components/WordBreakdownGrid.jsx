      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {hasGenerated && (
          <button
            ...
            onClick={onGenerate}
            disabled={isLoading}
            className="text-[11px] font-bold text-[#5842f5] hover:underline flex items-center gap-1 disabled:opacity-50"
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] theme-text-faint font-medium">3D Flip ↻</span>
                        </div>
                      ...
                      >
                        ...
                        <span className="text-[10.5px] theme-text-muted font-semibold">
                          Balik lagi &larr;
                        </span>
                      </div>
                    </div>
